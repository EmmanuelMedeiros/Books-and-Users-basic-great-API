...
const pagination_module_1 = require("../common/pagination/module/pagination.module");
...
exports.BookModule = BookModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [typeorm_1.TypeOrmModule.forFeature([book_entity_1.Book]), pagination_module_1.paginationModule],
